...
# # --- CHANGE 1: Added a control variable ---
# TIME_WINDOW = 10.0 
...
# print(f"Starting workload generator targeting: {FUNCTION_URL}")
# print(f"Compressing traffic into {TIME_WINDOW} second windows!")
# print("Press Ctrl+C to stop...")

# for _ in range(100):
#     for i in d: 
#         # --- CHANGE 2: Using the control variable ---
#         total_time = TIME_WINDOW
#         try:
#             if i == 0:
#                 # --- CHANGE 3: Sleep for the compressed window ---
#                 sleep(TIME_WINDOW)
#                 continue

#             average_inter_arrival_time = total_time/i
            
#             # --- CHANGE 4: The Mathematical Fix ---
#             times = np.random.exponential(scale=average_inter_arrival_time, size=i)
